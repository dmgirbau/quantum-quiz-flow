...
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'pending_student';
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'pending_professor';

-- Add approval system fields to user_roles (skip created_at since it exists)
